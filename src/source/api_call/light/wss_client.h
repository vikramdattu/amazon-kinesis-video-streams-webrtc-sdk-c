 ...
 * @return
 */
PVOID wss_client_start(WssClientContext* pWssClientCtx);
STATUS wss_client_sendText(WssClientContext* pCtx, UINT8* buf, UINT32 len);
STATUS wss_client_sendBinary(WssClientContext* pCtx, UINT8* buf, UINT32 len);
STATUS wss_client_sendPing(WssClientContext* pCtx);
