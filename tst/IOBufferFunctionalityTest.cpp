...
TEST_F(IOBufferFunctionalityTest, writeReadDataAndVerifyStartWithEmptyBuffer)
{
    ...
    EXPECT_EQ(STATUS_SUCCESS, io_buffer_create(0, &pIOBuffer));
    ...
    EXPECT_EQ(STATUS_SUCCESS, io_buffer_write(pIOBuffer, (PBYTE) data, dataLen));
    ...
    EXPECT_EQ(STATUS_SUCCESS, io_buffer_read(pIOBuffer, pBuff, dataLen, &readLen));
    ...
    EXPECT_EQ(STATUS_SUCCESS, io_buffer_free(&pIOBuffer));
...
TEST_F(IOBufferFunctionalityTest, writeReadDataAndVerifyStartWithPreinitializedBuffer)
{
    ...
    EXPECT_EQ(STATUS_SUCCESS, io_buffer_create(initCap, &pIOBuffer));
    EXPECT_TRUE(pIOBuffer != NULL);
